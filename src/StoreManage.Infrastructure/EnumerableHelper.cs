...
namespace StoreManage.Infrastructure
{
    public static class EnumerableHelper
    {
        ...
        public static bool SetEquals<T>(this IEnumerable<T> source, IEnumerable<T> second)
        {
        ...
        {
            underlyingType = type.IsInterface && type.IsGenericType && type.GetGenericTypeDefinition() == typeof(IEnumerable<>)
